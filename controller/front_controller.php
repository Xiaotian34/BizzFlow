...
define('CONTROLLERS_FOLDER',"controller/");//Controlador
//Si no se indica un controlador, este es el controlador que se usará por defecto
define('DEFAULT_CONTROLLER',"documentos"); //productos
...
$controller = CONTROLLERS_FOLDER . $controller . '_controller.php'; //_controlador.php
